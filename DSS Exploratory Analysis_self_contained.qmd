...
Below is an example of how the dataset can be used to track the prevalence of indicator values in the DSS and total populations over time. You can perform an interactive analysis using the **Prevalence Calculator** by following the link below:

[Go to the Prevalence Calculator](https://datart.shinyapps.io/prevalenceappclean/)
...
Explore the interactive **Insight Maker Model** by following the link below. This tool allows for deeper exploration of the relationships within the DSS data:

[Go to the Insight Maker Model](https://insightmaker.com/insight/elL0WWiBgIx1EW0lYLL5c/embed?topBar=1&sideBar=1&zoom=1)
